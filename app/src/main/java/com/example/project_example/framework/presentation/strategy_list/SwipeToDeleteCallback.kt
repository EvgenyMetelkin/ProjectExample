...
import com.example.project_example.framework.base.px
import com.example.project_example.framework.presentation.strategy_list.adapter.StrategyViewHolder
...
abstract class SwipeToDeleteCallback(private val context: Context) : ItemTouchHelper.Callback() {
    ...
    override fun getMovementFlags(
        ...
        if (viewHolder is StrategyViewHolder) {
    ...
    private fun drawIcon(canvas: Canvas, itemView: View, icon: Drawable) {
        ...
        canvas.drawText(
            ...
            0,
            6,
            left.toFloat() - (textBounds.width() - iconWidth) / 2f,
            bottom + 17f.px,
            textPaint
        )
